...
*/
// write your code here
print("I have $\(availableBalance) in my bank account")
...
*/
// write your code here
print("I now have $\(availableBalance + 100)")
...
// this does not work because i declared the String a Constant aka *let*
